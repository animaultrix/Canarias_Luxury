...
class AdminVerOcios extends StatefulWidget {
  const AdminVerOcios({Key? key}) : super(key: key);

  @override
  _AdminVerOciosState createState() => _AdminVerOciosState();
}

class _AdminVerOciosState extends State<AdminVerOcios> {
                  ...
                  return Column(
                    children: snapshot.data!.map<Widget>((image) {
                      return Padding(
                        ...
                        child: CardImages(carruselImages: image, isOcio: true, disableAddButton: true),
                      );
                    }).toList(),
                  );
                }
